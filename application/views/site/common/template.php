...
<div class="header">
	<div class="wrapper">
		...
		<div class="header-contacts">
			<div class="row mb5">
				<div class="col-6 phone"><?=phone($siteinfo['phone'], $siteinfo['phoneMask']);?></div>
				<div class="col-6 phone"><?=phone($siteinfo['phone2'], $siteinfo['phone2Mask']);?></div>
			</div>
			<div class="row">
				<div class="col-6 phone"><?=phone($siteinfo['phoneCity'], $siteinfo['phoneCityMask']);?></div>
				<div class="col-6 email"><?=$siteinfo['email'];?></div>
			</div>
		</div>
	</div>
</div>
		...
		<div class="wrapper">
			<div class="row">
				<div class="col-4">
					...
					<div class="bold mb5"><?=$siteinfo['title'];?></div>
					<div class="copyright">&copy; <?=date('Y');?> <span class="ml5 mr5">|</span> Все права защищены</div>
				</div>
				<div class="col-4">
					<div class="row">
					<? foreach($fmenu as $_fmenu) { ?>
						<div class="col-6">
							<div class="f-title"><?=$_fmenu['title'];?></div>
							<ul class="f-menu">
				...
				<div class="col-4">
					<div class="f-phone mb10"><?=phone($siteinfo['phone'], $siteinfo['phoneMask']);?></div>
					<div class="f-adres mb10"><?=$siteinfo['adres'];?></div>
